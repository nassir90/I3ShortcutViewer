...
You should be able to scroll using the mouse, arrow keys, page up buttons and C-n and C-p keys (emacs). Scrolling should feel fluid and soft like in a web browser as opposed to being done in
  jumps.
