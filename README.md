...
**Note:** All of the code in this project was generated by Claude based on iterating on the specification above. The content below was also generated by Claude to help potential users (take it with a grain of salt).
